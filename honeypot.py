...
HOST_KEY_PATH = os.environ.get("HONEYPOT_HOST_KEY", "./keys/fake_host_key")
LOG_FILE = os.environ.get("HONEYPOT_LOG_DIR", "./logs") + "/attempts.jsonl"
CMD_LOG_FILE = os.environ.get("HONEYPOT_LOG_DIR", "./logs") + "/commands.jsonl"
BANNER = os.environ.get("HONEYPOT_BANNER", "SSH-2.0-OpenSSH_8.9p1 Ubuntu-3ubuntu0.6")
...
def main():
    ...
    if not os.path.exists(HOST_KEY_PATH):
        logger.info(f"Host key not found, generating: {HOST_KEY_PATH}")
